...
export default function BookOffice() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log("Form data is valid, submitting to server", formData);
    ...
    try {
      ...
      console.log("Booking transaction created", response.data);
      ...
      if (axios.isAxiosError(error)) {
        console.error("Error creating booking transaction:", error.message);
      } else {
        console.error("Unexpected error:", error);
      }
    } finally {
